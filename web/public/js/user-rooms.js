...
$('#search_room_title').on('keyup', event => {
  ...
  request.get({
    url: `http://localhost:8082/rooms/title/${search}`,
    headers: {
...
$('#join_room').on('click', event => {
  ...
  request.post({
    url: `http://localhost:8082/rooms/${roomId}/join`,
    headers: {
      'Content-Type': 'application/json',
      Authorization: auth,
    },
...
$('#leave_active_room').on('click', event => {
  ...
  request.delete({
    url: `http://localhost:8082/rooms/${roomId}/leave`,
    headers: {
      'Content-Type': 'application/json',
      Authorization: auth,
    },
...
$('#delete_active_room').on('click', event => {
  ...
  request.delete({
    url: `http://localhost:8082/rooms/${roomId}`,
    headers: {
      'Content-Type': 'application/json',
      Authorization: auth,
    },
